...
async function runUseJssdk() {
    ...
    await luckyDraw.addDrawPlan(2, 1, 2, 2e18,).sendTransaction({ from: sender, value: 2 * 1e18 }).executed()
    await luckyDraw.addDrawPlan(1, 1, 1, 3e18,).sendTransaction({ from: sender, value: 1 * 1e18 }).executed()
    console.log("add draw plan done")
}
